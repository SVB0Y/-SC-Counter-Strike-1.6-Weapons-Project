//Counter-Strike Condition Zero Leone YG1265 Auto Shotgun (Benelli M4 Super 90)
/* Model Credits
/ Model: Valve
/ Textures: Valve
/ Animations: Valve
...
namespace CSCZ_XM1014
{

// Animations
enum CSCZ_Xm1014_Animations
{
	IDLE = 0,
	SHOOT1,
	SHOOT2,
...
// Models
string W_MODEL  	= "models/csczsven/wpn/xm1014/w_xm1014.mdl";
string V_MODEL  	= "models/csczsven/wpn/xm1014/v_xm1014.mdl";
string P_MODEL  	= "models/csczsven/wpn/xm1014/p_xm1014.mdl";
...
string SHOOT_S  	= "csczsven/xm1014/shoot.wav";
// Information
int MAX_CARRY   	= 96;
int MAX_CLIP    	= 7;
...
class weapon_csczxm1014 : ScriptBasePlayerWeaponEntity, CSCZBASE::WeaponBase
{
	...
	void Precache()
	{
		...
		m_iShell = g_Game.PrecacheModel( CSCZBASE::SHELL_SHOTGUN );
		//Entity
	...
	{
		info.iMaxAmmo1 	= (CSCZBASE::ShouldUseCustomAmmo) ? MAX_CARRY : CSCZBASE::DF_MAX_CARRY_BUCK;
...
class CSXM1014_MAG : ScriptBasePlayerAmmoEntity, CSCZBASE::AmmoBase
{
	void Spawn()
	{
		Precache();
	...
	{
		return CommonAddAmmo( pOther, MAX_CLIP, (CSCZBASE::ShouldUseCustomAmmo) ? MAX_CARRY : CSCZBASE::DF_MAX_CARRY_BUCK, (CSCZBASE::ShouldUseCustomAmmo) ? AMMO_TYPE : CSCZBASE::DF_AMMO_BUCK );
	}
}

string GetAmmoName()
{
	return "ammo_csczxm1014";
}

string GetName()
{
	return "weapon_csczxm1014";
}

void Register()
{
	CSCZBASE::RegisterCWEntity( "CSCZ_XM1014::", "weapon_csczxm1014", GetName(), GetAmmoName(), "CSXM1014_MAG", 
		CSCZBASE::MAIN_CSTRIKE_DIR + SPR_CAT, (CSCZBASE::ShouldUseCustomAmmo) ? AMMO_TYPE : CSCZBASE::DF_AMMO_BUCK );
}
