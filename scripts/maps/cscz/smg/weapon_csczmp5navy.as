// Counter-Strike Condition Zero K&M Sub-Machine Gun (H&K MP5A5-Navy)
/* Model Credits
/ Model: Valve
/ Textures: Valve
/ Animations: Valve
...
// Models
string W_MODEL  	= "models/csczsven/wpn/mp5/w_mp5.mdl";
string V_MODEL  	= "models/csczsven/wpn/mp5/v_mp5.mdl";
string P_MODEL  	= "models/csczsven/wpn/mp5/p_mp5.mdl";
...
array<string> 		WeaponSoundEvents = {
					"csczsven/mp5/magout.wav",
					"csczsven/mp5/magin.wav",
					"csczsven/mp5/sldbk.wav"
};
string SHOOT_S  	= "csczsven/mp5/shoot.wav";
// Information
int MAX_CARRY   	= 120;
int MAX_CLIP    	= 30;
...
class weapon_csczmp5navy : ScriptBasePlayerWeaponEntity, CSCZBASE::WeaponBase
{
...
class MP5_MAG : ScriptBasePlayerAmmoEntity, CSCZBASE::AmmoBase
{
	void Spawn()
	{
		Precache();
...
string GetAmmoName()
{
	return "ammo_csczmp5navy";
}

string GetName()
{
	return "weapon_csczmp5navy";
}

void Register()
{
	CSCZBASE::RegisterCWEntity( "CSCZ_MP5::", "weapon_csczmp5navy", GetName(), GetAmmoName(), "MP5_MAG", 
