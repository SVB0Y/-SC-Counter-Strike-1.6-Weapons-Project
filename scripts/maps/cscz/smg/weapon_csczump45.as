// Counter-Strike Condition Zero K&M UMP45 (H&K UMP45)
/* Model Credits
/ Model: Valve
/ Textures: Valve
/ Animations: Valve
...
namespace CSCZ_UMP45
{

// Animations
enum CSCZ_Ump45_Animations
{
	IDLE = 0,
	RELOAD,
	DRAW,
...
// Models
string W_MODEL  	= "models/csczsven/wpn/ump45/w_ump45.mdl";
string V_MODEL  	= "models/csczsven/wpn/ump45/v_ump45.mdl";
string P_MODEL  	= "models/csczsven/wpn/ump45/p_ump45.mdl";
...
array<string> 		WeaponSoundEvents = {
					"csczsven/ump45/magout.wav",
					"csczsven/ump45/magin.wav",
					"csczsven/ump45/blt.wav"
};
string SHOOT_S  	= "csczsven/ump45/shoot.wav";
// Information
int MAX_CARRY   	= 240;
int MAX_CLIP    	= 25;
...
class weapon_csczump45 : ScriptBasePlayerWeaponEntity, CSCZBASE::WeaponBase
{
...
class UMP45_MAG : ScriptBasePlayerAmmoEntity, CSCZBASE::AmmoBase
{
	void Spawn()
	{
		Precache();
...
string GetAmmoName()
{
	return "ammo_csczump45";
}

string GetName()
{
	return "weapon_csczump45";
}

void Register()
{
	CSCZBASE::RegisterCWEntity( "CSCZ_UMP45::", "weapon_csczump45", GetName(), GetAmmoName(), "UMP45_MAG", 
