// Counter-Strike Condition Zero Night Hawk .50C (IMI Desert Eagle Mark XIX)
/* Model Credits
/ Model: Valve
/ Textures: Valve
/ Animations: Valve
...
namespace CSCZ_DEAGLE
{

// Animations
enum CSCZ_Deagle_Animation
{
	IDLE = 0,
	SHOOT1,
	SHOOT2,
...
// Models
string W_MODEL  	= "models/csczsven/wpn/eagle/w_eagle.mdl";
string V_MODEL  	= "models/csczsven/wpn/eagle/v_eagle.mdl";
string P_MODEL  	= "models/csczsven/wpn/eagle/p_eagle.mdl";
...
array<string> 		WeaponSoundEvents = {
					"csczsven/eagle/magin.wav",
					"csczsven/eagle/magout.wav"
};
string SHOOT_S  	= "csczsven/eagle/shoot.wav";
// Information
int MAX_CARRY   	= 35;
int MAX_CLIP    	= 7;
...
class weapon_csczdeagle : ScriptBasePlayerWeaponEntity, CSCZBASE::WeaponBase
{
...
class DEAGLE_MAG : ScriptBasePlayerAmmoEntity, CSCZBASE::AmmoBase
{
	void Spawn()
	{
		Precache();
...
string GetAmmoName()
{
	return "ammo_csczdeagle";
}

string GetName()
{
	return "weapon_csczdeagle";
}

void Register()
{
	CSCZBASE::RegisterCWEntity( "CSCZ_DEAGLE::", "weapon_csczdeagle", GetName(), GetAmmoName(), "DEAGLE_MAG", 
