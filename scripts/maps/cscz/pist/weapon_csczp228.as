// Counter-Strike Condition Zero 228 Compact (SIG-Sauer P228)
/* Model Credits
/ Model: Valve
/ Textures: Valve
/ Animations: Valve
...
// Models
string W_MODEL  	= "models/csczsven/wpn/p228/w_p228.mdl";
string V_MODEL  	= "models/csczsven/wpn/p228/v_p228.mdl";
string P_MODEL  	= "models/csczsven/wpn/p228/p_p228.mdl";
...
array<string> 		WeaponSoundEvents = {
					"csczsven/p228/magin.wav",
					"csczsven/p228/magout.wav",
					"csczsven/p228/sldbk.wav",
					"csczsven/p228/sldrl.wav"
};
string SHOOT_S  	= "csczsven/p228/shoot.wav";
// Information
int MAX_CARRY   	= 130;
int MAX_CLIP    	= 13;
...
class weapon_csczp228 : ScriptBasePlayerWeaponEntity, CSCZBASE::WeaponBase
{
...
class P228_MAG : ScriptBasePlayerAmmoEntity, CSCZBASE::AmmoBase
{
	void Spawn()
	{
		Precache();
...
string GetAmmoName()
{
	return "ammo_csczp228";
}

string GetName()
{
	return "weapon_csczp228";
}

void Register()
{
	CSCZBASE::RegisterCWEntity( "CSCZ_P228::", "weapon_csczp228", GetName(), GetAmmoName(), "P228_MAG", 
