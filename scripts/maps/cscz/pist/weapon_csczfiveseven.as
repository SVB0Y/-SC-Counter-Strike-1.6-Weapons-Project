// Counter-Strike Condition Zero ES Five-SeveN (FN Five-seven)
/* Model Credits
/ Model: Valve
/ Textures: Valve
/ Animations: Valve
...
// Models
string W_MODEL  	= "models/csczsven/wpn/57/w_57.mdl";
string V_MODEL  	= "models/csczsven/wpn/57/v_57.mdl";
string P_MODEL  	= "models/csczsven/wpn/57/p_57.mdl";
...
array<string> 		WeaponSoundEvents = {
					"csczsven/57/magin.wav",
					"csczsven/57/magout.wav",
					"csczsven/57/sldbk.wav",
					"csczsven/57/sldrl.wav"
};
string SHOOT_S  	= "csczsven/57/shoot.wav";
// Information
int MAX_CARRY   	= 500;
int MAX_CLIP    	= 20;
...
class weapon_csczfiveseven : ScriptBasePlayerWeaponEntity, CSCZBASE::WeaponBase
{
...
class FIVE7_MAG : ScriptBasePlayerAmmoEntity, CSCZBASE::AmmoBase
{
	void Spawn()
	{
		Precache();
...
string GetAmmoName()
{
	return "ammo_csczfiveseven";
}

string GetName()
{
	return "weapon_csczfiveseven";
}

void Register()
{
	CSCZBASE::RegisterCWEntity( "CSCZ_57::", "weapon_csczfiveseven", GetName(), GetAmmoName(), "FIVE7_MAG", 
