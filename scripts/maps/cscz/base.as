...
//Model files
string SCOPE_MODEL      	= "models/csczsven/wpn/scope.mdl";
string SHELL_PISTOL     	= "models/csczsven/shells/pshell.mdl";
string SHELL_RIFLE      	= "models/csczsven/shells/rshell.mdl";
string SHELL_SNIPER     	= "models/csczsven/shells/rshell_big.mdl";
string SHELL_SHOTGUN    	= "models/hlclassic/shotgunshell.mdl";
//Sound files
string EMPTY_PISTOL_S   	= "csczsven/misc/emptyp.wav";
string EMPTY_RIFLE_S    	= "csczsven/misc/emptyr.wav";
string AMMO_PICKUP_S    	= "hlclassic/items/9mmclip1.wav";
string ZOOM_SOUND       	= "csczsven/misc/zoom.wav";
//Main Sprite Folder
string MAIN_SPRITE_DIR  	= "sprites/";
string MAIN_CSTRIKE_DIR 	= "cscz/";
//Zoom information
...
mixin class WeaponBase
{
	...
	{
		//MuzzleFlash
		g_Game.PrecacheModel( MAIN_SPRITE_DIR + MAIN_CSTRIKE_DIR + "csczflashx.spr" );
		g_Game.PrecacheGeneric( "events/" + "cscz_flashx.txt" );
		//HUD
		g_Game.PrecacheGeneric( MAIN_SPRITE_DIR + MAIN_CSTRIKE_DIR + "cscz1024.spr" );
...
mixin class MeleeWeaponBase2
{
	protected TraceResult m_trHit;
	protected int m_iSwing = 0;

	bool Swing( float flDamage, string szSwingSound, string szHitFleshSound, string szHitWallSound, int& in iAnimAtk1, int& in iAnimAtk2, int& in iBodygroup, 
		float flHitDist = 48.0f, float flMissNextPriAtk = 0.50f, float flHitNextPriAtk = 0.55f, float flNextSecAtk = 0.66f )
	{
		TraceResult tr;
		bool fDidHit = false;
		...
		else
		{
			...
			if( self.m_flNextPrimaryAttack + 0.4f < g_Engine.time )
				...
				pEntity.TraceAttack( m_pPlayer.pev, flDamage * 1, g_Engine.v_forward, tr, DMG_SLASH | DMG_CLUB ); // subsequent swings do 75% (Changed -Sniper)
	...
	bool Stab( float flDamage, string szSwingSound, string szHitFleshSound, string szHitWallSound, int& in iAnimAtkMiss, int& in iAnimAtkHit, int& in iBodygroup, 
		float flHitDist = 64.0f, float flMissNextAtk = 1.2f, float flHitNextAtk = 1.4f )
	{
		TraceResult tr;
		bool fDidHit = false;
