// Counter-Strike Condition Zero Magnum Sniper Rifle (AWP)
/* Model Credits
/ Model: Valve
/ Textures: Valve
/ Animations: Valve
...
// Models
string W_MODEL  	= "models/csczsven/wpn/awp/w_awp.mdl";
string V_MODEL  	= "models/csczsven/wpn/awp/v_awp.mdl";
string P_MODEL  	= "models/csczsven/wpn/awp/p_awp.mdl";
...
array<string> 		WeaponSoundEvents = {
					"csczsven/awp/bltbk.wav",
					"csczsven/awp/bltdn.wav",
					"csczsven/awp/bltup.wav",
					"csczsven/awp/magout.wav",
					"csczsven/awp/magin.wav"
};
string SHOOT_S  	= "csczsven/awp/shoot.wav";
// Information
int MAX_CARRY   	= 100;
int MAX_CLIP    	= 10;
...
float RPM       	= 1.40f;
string AMMO_TYPE 	= "CSCZ_.338lapua";
float AIM_SPEED 	= 150;

//Buy Menu Information
string WPN_NAME 	= "Arctic Warfare Police";
uint WPN_PRICE  	= 500;
string AMMO_NAME 	= "AWP .338 Lapua Magazine";
uint AMMO_PRICE  	= 30;

class weapon_csczawp : ScriptBasePlayerWeaponEntity, CSCZBASE::WeaponBase
{
	...
	void Reload()
	{
		...
		Reload( MAX_CLIP, RELOAD, (87.0/30.0), GetBodygroup() );
...
class AWP_MAG : ScriptBasePlayerAmmoEntity, CSCZBASE::AmmoBase
{
	void Spawn()
	{
		Precache();
...
string GetName()
{
	return "weapon_csczawp";
}

void Register()
{
	CSCZBASE::RegisterCWEntity( "CSCZ_AWP::", "weapon_csczawp", GetName(), GetAmmoName(), "AWP_MAG", 
