// Counter-Strike Condition Zero D3/AU-1 (G3SG1)
/* Model Credits
/ Model: Valve
/ Textures: Valve
/ Animations: Valve
...
namespace CSCZ_G3SG1
{

// Animations
enum CSCZ_G3sg1_Animations
{
	IDLE = 0,
	SHOOT1,
	SHOOT2,
...
// Models
string W_MODEL  	= "models/csczsven/wpn/g3sg1/w_g3sg1.mdl";
string V_MODEL  	= "models/csczsven/wpn/g3sg1/v_g3sg1.mdl";
string P_MODEL  	= "models/csczsven/wpn/g3sg1/p_g3sg1.mdl";
...
array<string> 		WeaponSoundEvents = {
					"csczsven/g3sg1/magout.wav",
					"csczsven/g3sg1/magin.wav",
					"csczsven/g3sg1/sld.wav"
};
string SHOOT_S  	= "csczsven/g3sg1/shoot.wav";
// Information
int MAX_CARRY   	= 300;
int MAX_CLIP    	= 20;
...
class weapon_csczg3sg1 : ScriptBasePlayerWeaponEntity, CSCZBASE::WeaponBase
{
	...
	void PrimaryAttack()
	{
		...
		vecSpread = (WeaponZoomMode != CSCZBASE::MODE_FOV_NORMAL) ? vecSpread * (m_iShotsFired * 0.21f) : vecSpread * (m_iShotsFired * 0.19f); // do vector math calculations here to make the Spread worse
...
class G3SG1_MAG : ScriptBasePlayerAmmoEntity, CSCZBASE::AmmoBase
{
	void Spawn()
	{
		Precache();
...
string GetAmmoName()
{
	return "ammo_csczg3sg1";
}

string GetName()
{
	return "weapon_csczg3sg1";
}

void Register()
{
	CSCZBASE::RegisterCWEntity( "CSCZ_G3SG1::", "weapon_csczg3sg1", GetName(), GetAmmoName(), "G3SG1_MAG", 
