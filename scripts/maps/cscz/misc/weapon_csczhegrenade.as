//Counter-Strike Condition Zero High Explosive Grenade
/* Model Credits
/ Model: Valve
/ Textures: Valve
/ Animations: Valve
...
#include "../base"
#include "../proj/proj_csczgren"

namespace CSCZ_HEGRENADE
{

// Animations
enum CSCZ_Hegrenades_Animations 
{
	IDLE = 0,
	PULLPIN,
	THROW,
...
// Models
string W_MODEL  	= "models/csczsven/wpn/he/w_he.mdl";
string V_MODEL  	= "models/csczsven/wpn/he/v_he.mdl";
string P_MODEL  	= "models/csczsven/wpn/he/p_he.mdl";
// Sprites
...
class weapon_csczhegrenade : ScriptBasePlayerWeaponEntity, CSCZBASE::WeaponBase, CSCZBASE::GrenadeWeaponExplode
{
	...
	void Precache()
	{
		...
		//Entities
		g_Game.PrecacheOther( CSCZGRENADEPROJECTILE::DEFAULT_PROJ_NAME );
		//Sounds
	...
	void LaunchThink()
	{
		...
		CSCZGRENADEPROJECTILE::CCSCZGrenade@ pGrenade2 = CSCZGRENADEPROJECTILE::TossGrenade( m_pPlayer.pev, vecSrc, vecThrow, TIMER, DAMAGE, W_MODEL );
...
string GetName()
{
	return "weapon_csczhegrenade";
}

void Register()
{
	CSCZGRENADEPROJECTILE::Register();
	CSCZBASE::RegisterCWEntityEX( "CSCZ_HEGRENADE::", "weapon_csczhegrenade", GetName(), GetName(), CSCZBASE::MAIN_CSTRIKE_DIR + SPR_CAT, AMMO_TYPE );
}
